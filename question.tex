...
%It is well possible to compute explicitly the image of an element of $\HH_2(G, \ZZ)$ under $\psi$, however, 
...
It remains to compute the loop homotopic to the image of the path $\gamma_{x,y}$ from~\eqref{eq:pathT} via $\phi$. %, which can be done via repeated computation of 3-dimensional fillers in $\ZZ[BG]$.
