...
\vfill \pagebreak 
\appendix
\section{Simplicial Dold---Serre fibrations}
...
We show in~\cref{lm:dhlp,lm:weak-equiv} that the map $h_\infty$ has this lifting property and that every map with this property is a quasifibration.
...
\end{lemma}
\begin{proof}
 We reduce the original problem to the special case $g=0$.
