...
\begin{example} 
 We leave it as an exercise to the reader to check that an element $[h_{12}(a), h_{13}(b)] \in \pi_1(S)$ corresponds to the following element of $\pi_1(T)$
  under the isomorphism of \cref{lm:quillen-a}:
 \begin{multline} \nonumber
  (a[1], a[1]) (a^{-1}[1], a^{-1}[2]) (b[1], b[1]) (b^{-1}[1], b^{-1}[3]) \cdot \\ (a[1], a[2]) (a^{-1}[1], a^{-1}[1]) (b[1], b[3]) (b^{-1}[1], b^{-1}[1])).
 \end{multline}  
\end{example}
