...
\begin{proof}
 ...
 \begin{itemize}
  ...
  \item Applying the approximation theorem to $A'$ (with the initial condition on the boundary $\partial (D_k \times I) = D^k\times \{0\} \cup J$ given by 
    $a''$ and $const_b$, respectively) we find an integer $r>q$ and the approximation $A''\colon \sd^{r}(D_k \times I) \to B$ homotopic to $A'$ rel $\partial (D_k \times I)$
     so that $(a'', A'')$ form the following commutative diagram of simplicial sets
   \begin{equation} \nonumber \xymatrix{ 
